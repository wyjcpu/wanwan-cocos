...
import org.wanwanframework.coco.datasource.pool.interceptor.ConnectionState;
...
public class PooledConnection {
     ...
     * @param password the password you wish to connect with, pass in null to accept the default username from {@link org.wanwanframework.coco.datasource.pool.PoolConfiguration#getPassword()}
    ...
    protected void connectUsingDriver() throws SQLException {
        ...
        try {
            ...
            if (parent.jmxPool!=null) {
                parent.jmxPool.notify(org.wanwanframework.coco.datasource.pool.jmx.ConnectionPool.NOTIFY_CONNECT,
...
//============================================================================
     ...
     * This timestamp can also be reset by the {@link org.wanwanframework.coco.datasource.pool.interceptor.ResetAbandonedTimer#invoke(Object, java.lang.reflect.Method, Object[])}

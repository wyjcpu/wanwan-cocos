 ...
 */
package org.wanwanframework.coco.datasource.pool.jmx;
...
import org.wanwanframework.coco.datasource.pool.PoolConfiguration;
import org.wanwanframework.coco.datasource.pool.PoolUtilities;
import org.wanwanframework.coco.datasource.pool.Validator;
...
public class ConnectionPool extends NotificationBroadcasterSupport implements ConnectionPoolMBean  {
     ...
     * the connection pool
     */
    protected org.wanwanframework.coco.datasource.pool.ConnectionPool pool = null;
    /**
    ...
    public ConnectionPool(org.wanwanframework.coco.datasource.pool.ConnectionPool pool) {
        super();
        this.pool = pool;
    }

    public org.wanwanframework.coco.datasource.pool.ConnectionPool getPool() {
        return pool;
    }

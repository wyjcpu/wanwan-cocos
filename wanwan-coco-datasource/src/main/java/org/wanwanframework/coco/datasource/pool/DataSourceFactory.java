...
public class DataSourceFactory implements ObjectFactory {
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        if (org.wanwanframework.coco.datasource.pool.CocoDataSource.class.getName().equals(ref.getClassName())) {
            ok = true;
        }
    ...
    public DataSource createDataSource(Properties properties,Context context, boolean XA) throws Exception {
        ...
        org.wanwanframework.coco.datasource.pool.CocoDataSource dataSource = XA?
                new org.wanwanframework.coco.datasource.pool.XADataSource(poolProperties) :
                new org.wanwanframework.coco.datasource.pool.CocoDataSource(poolProperties);

...
import org.wanwanframework.coco.datasource.pool.PoolProperties.InterceptorDefinition;
...
public interface PoolConfiguration {
     ...
     * @see org.wanwanframework.coco.datasource.pool.interceptor.ResetAbandonedTimer
     */
    ...
    /**
     * A semicolon separated list of classnames extending {@link org.wanwanframework.coco.datasource.pool.JdbcInterceptor} class.
     * These interceptors will be inserted as an interceptor into the chain of operations on a java.sql.Connection object.
     * Example interceptors are {@link org.wanwanframework.coco.datasource.pool.interceptor.StatementFinalizer StatementFinalizer} to close all
     * used statements during the session.
     * {@link org.wanwanframework.coco.datasource.pool.interceptor.ResetAbandonedTimer ResetAbandonedTimer} resets the timer upon every operation
     * on the connection or a statement.
     * {@link org.wanwanframework.coco.datasource.pool.interceptor.ConnectionState ConnectionState} caches the auto commit, read only and catalog settings to avoid round trips to the DB.
     * The default value is null.
    ...
    /**
     * If set to true, the connection pool creates a {@link org.wanwanframework.coco.datasource.pool.jmx.ConnectionPoolMBean} object

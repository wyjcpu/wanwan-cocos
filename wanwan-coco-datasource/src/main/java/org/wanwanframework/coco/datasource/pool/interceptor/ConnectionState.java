 ...
 */
package org.wanwanframework.coco.datasource.pool.interceptor;
...
import org.wanwanframework.coco.datasource.pool.ConnectionPool;
import org.wanwanframework.coco.datasource.pool.DataSourceFactory;
import org.wanwanframework.coco.datasource.pool.JdbcInterceptor;
import org.wanwanframework.coco.datasource.pool.PoolConfiguration;
import org.wanwanframework.coco.datasource.pool.PooledConnection;

/**
 * Interceptor that keep track of connection state to avoid roundtrips to the database.
 * The {@link org.wanwanframework.coco.datasource.pool.ConnectionPool} is optimized to do as little work as possible.
